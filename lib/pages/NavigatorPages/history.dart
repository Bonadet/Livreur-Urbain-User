                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        MyText(
                                                                          text:
                                                                              myHistory[i]['converted_cancelled_at'].toString(),
                                                                          size: media.width *
                                                                              twelve,
                                                                          fontweight:
                                                                              FontWeight.w600,
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      (myHistory[i]['is_out_station'] ==
                                                                              1)
                                                                          ? MyText(
                                                                              text: languages[choosenLanguage]['text_outstation_ride'],
                                                                              size: media.width * sixteen,
                                                                              fontweight: FontWeight.w600,
                                                                            )
                                                                          : Container(),
                                                                      (myHistory[i]['is_driver_started'] ==
                                                                              1)
                                                                          ? Container()
                                                                          : InkWell(
                                                                              onTap: () async {
                                                                      ...
                                                                      if (myHistory[i]
                                                                        ...
                                                                        addressList.add(AddressList(
                                                                            ...
                                                                            pickup:
                                                                                true,
                                                                            latlng:
                                                                                LatLng(myHistory[i]['pick_lat'], myHistory[i]['pick_lng']),
                                                                        ...
                                                                        if (_tripStops
                                                                          ...
                                                                          for (var i = 0;
                                                                            ...
                                                                            addressList.add(AddressList(
                                                                                ...
                                                                                latlng: LatLng(_tripStops[i]['latitude'], _tripStops[i]['longitude']),
                                                                                name: '',
                                                                                number: '',
                                                                                instructions: null,
                                                                                pickup: false));
                                                                        ...
                                                                        if (myHistory[i]['drop_address'] !=
                                                                          ...
                                                                          addressList.add(AddressList(
                                                                              ...
                                                                              latlng: LatLng(myHistory[i]['drop_lat'], myHistory[i]['drop_lng'])));
                                                                        }
                                                                        ismulitipleride =
                                                                            true;
                                                                        var val =
                                                                            await getUserDetails(id: myHistory[i]['id']);
                                                                        ...
                                                                        if (val ==
                                                                          ...
                                                                          null) {
                                                                        selectedOutStation =
                                                                            '${myHistory[i]['currency'].toString()} ${myHistory[i]['offerred_ride_fare'].toString()}';
                                                                        setState(
                                                                            () {});
                                                                        ...
                                                                        Navigator.push(
                                                                            ...
                                                                            MaterialPageRoute(
                                                                                builder: (context) => OutStationDetails(
                                                                                      requestId: myHistory[i]['id'],
                                                                                      i: selectedOutStation,
                                                                                    )));
                                                                      }
                                                                    },
                                                                    child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Row(
                                                                            children: [
                                                                              ...
                                                                              (myHistory[i]['is_round_trip'] == 1)
                                                                                  ? MyText(
                                                                                      text: ' TO ${myHistory[i]['return_time']}',
                                                                                      size: media.width * fourteen,
                                                                                      fontweight: FontWeight.w600,
                                                                                    )
                                                                                  : Container(),
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Expanded(
                                                                                        child: Row(
                                                                                          ...
                                                                                          children: [
                                                                                            MyText(
                                                                                              text: languages[choosenLanguage]['text_assigned'],
                                                                                              size: media.width * fourteen,
                                                                                              fontweight: FontWeight.w600,
                                                                                              color: online,
                                                                                            ),
                                                                              ...
                                                                              ? Row(
                                                                                  children: [
                                                                                    Expanded(
                                                                                      ...
                                                                                      child: Row(
                                                                                        children: [
                                                                                          ...
                                                                                          MyText(
                                                                                            text: (myHistory[i]['is_bid_ride'] == 1) ? languages[choosenLanguage]['text_offered_fare'] : languages[choosenLanguage]['text_total'],
                                                                                            size: media.width * fourteen,
                                                                                            fontweight: FontWeight.w600,
                                                                                          )
                                                                                        ],
                                                                                    ...
                                                                                    Expanded(
                                                                                        ...
                                                                                        child: MyText(
                                                                                          textAlign: TextAlign.end,
                                                                                          text: '${userDetails['currency_symbol']} ${(myHistory[i]['is_bid_ride'] == 1) ? (myHistory[i]['driverDetail'] != null) ? myHistory[i]['accepted_ride_fare'].toString() : myHistory[i]['offerred_ride_fare'].toString() : myHistory[i]['request_eta_amount'].toString()}',
                                                                                          size: media.width * fourteen,
                                                                                          fontweight: FontWeight.w600,
                                                                                          maxLines: 1,
                                                                                        ))
                                                                          ...
                                                                          (myHistory[i]['drop_address'] != null)
                                                                              ...
                                                                              : Container(),
                                                                          (myHistory[i]['goods_type'] != '-')
                                                                              ? MyText(
                                                                                  text: myHistory[i]['goods_type'],
                                                                                  size: media.width * twelve,
