                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            border:
                                                                                Border.all(color: isOneWayTrip ? buttonColor : page),
                                                                  ...
                                                                  MyText(
                                                                    ...
                                                                    text: (fromDate !=
                                                                        ...
                                                                        ? DateFormat('d MMM, h:mm a')
                                                                            ...
                                                                            .toString()
                                                                        : DateFormat('d MMM, h:mm a')
                                                                            .format(DateTime.now().add(Duration(minutes: int.parse(userDetails['user_can_make_a_ride_after_x_miniutes']))))
                                                                            .toString(),
                                                                    size: media
                                                                            .width *
                                                                        twelve,
                                                              ...
                                                              children: [
                                                                ...
                                                                Button(
                                                                    width: ((userDetails['show_ride_later_feature'] ==
                                                                            true))
                                                                        ? ((widget.type == null) ? etaDetails[choosenVehicle]['enable_bidding'] == false : true) &&
                                                                                !isOutStation
                                                                            ? media.width *
                                                                                0.42
                                                                            : media.width *
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (((rentalOption.isEmpty && (etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['total'] && etaDetails[choosenVehicle]['has_discount'] == false) || (rentalOption.isEmpty && etaDetails[choosenVehicle]['has_discount'] == true && etaDetails[choosenVehicle]['user_wallet_balance'] >= etaDetails[choosenVehicle]['discounted_totel'])) || (rentalOption.isEmpty && etaDetails[choosenVehicle]['payment_type'].toString().split(',').toList()[payingVia] != 'wallet')) ||
                                                                          ((rentalOption.isNotEmpty && (etaDetails[0]['user_wallet_balance'] >= rentalOption[choosenVehicle]['fare_amount']) && rentalOption[choosenVehicle]['has_discount'] == false) ||
                                                                              (rentalOption.isNotEmpty && rentalOption[choosenVehicle]['has_discount'] == true && etaDetails[0]['user_wallet_balance'] >= rentalOption[choosenVehicle]['discounted_totel']) ||
                                                                ...
                                                                (widget.type !=
                                                                    ...
                                                                    ? Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          (isOutStation && isOneWayTrip == false)
                                                                              ? Container()
                                                                          ...
                                                                          (isOutStation && isOneWayTrip == false)
                                                                              ...
                                                                              : Row(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    (etaDetails[_showInfoInt]['has_discount'] != true || etaDetails[_showInfoInt]['enable_bidding'] == true || isOutStation)
                                                                                        ? Row(
                                                                                            mainAxisAlignment: MainAxisAlignment.end,
                                                                                            children: [
                                                                                              Text(
                                                                                                '${etaDetails[_showInfoInt]['total'].toStringAsFixed(2)} ${etaDetails[_showInfoInt]['currency']}'
                                                                                        ...
                                                                                        : Row(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Text(
                                                                                                etaDetails[_showInfoInt]['total'].toStringAsFixed(2),
                                                                                                style: GoogleFonts.notoSans(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough),
                                                                                              ),
                                                                                              Text(
                                                                                                ' ${etaDetails[_showInfoInt]['discounted_totel'].toStringAsFixed(2)}',
                                                                                                style: GoogleFonts.notoSans(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600),
                                                                          ...
                                                                          TextField(
                                                                              ...
                                                                              decoration: InputDecoration(
                                                                                  ...
                                                                                  hintStyle: GoogleFonts.notoSans(fontSize: media.width * sixteen, color: hintColor, fontWeight: FontWeight.w600)),
                                                                              onChanged: (val) {
                                                                                setState(() {
                                                                                  fareError = '';
                                                                                });
                                                                          ...
                                                                          Button(
                                                                            onTap:
                                                                                () async {
                                                                              if (isOneWayTrip == true && yourAmount.text.isNotEmpty && double.parse(yourAmount.text) >= double.parse(etaDetails[_showInfoInt]['total'].round().toString())) {
                                                                                setState(() {
                                                                                  _isLoading = true;
                                                                                });
                                                                                    ...
                                                                                    if (choosenTransportType == 0) {
                                                                                      result = await createRequestLater(
                                                                                          jsonEncode({
                                                                                            ...
                                                                                            'is_bid_ride': 1,
                                                                                            'trip_start_time': fromDate.toString().substring(0, 19),
                                                                                            if (toDate != null) 'is_round_trip': true,
                                                                                            if (toDate != null) 'return_time': toDate.toString().substring(0, 19),
                                                                                            'is_later': true,
                                                                                            'is_out_station': true
                                                                                          }),
                                                                                          'api/v1/request/create');
                                                                                ...
                                                                                if (result == 'success') {
                                                                                  ...
                                                                                  if (isOutStation) {
                                                                                    FirebaseDatabase.instance.ref().child('bid-meta/${userRequestData["id"]}').update({
                                                                                      ...
                                                                                      'trip_start_time': DateFormat('d-MMM-y, h:mm a').format(fromDate).toString(),
                                                                                      if (toDate != null) 'return_time': DateFormat('d-MMM-y, h:mm a').format(toDate!).toString(),
                                                                                      'is_later': true,
                                                                                      'is_out_station': true
                                                                                    });
                                                                                    userRequestData.clear();
