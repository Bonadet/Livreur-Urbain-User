                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          (userDetails['show_rental_ride'] == true)
                                                                              ...
                                                                              : Container(),
                                                                          (userDetails['show_outstation_ride_feature'] == '1')
                                                                              ? Row(
                                                                                  children: [
                                                                                    Column(
                                                                                      children: [
                                                                                            ...
                                                                                            child: Container(
                                                                                                ...
                                                                                                decoration: BoxDecoration(
                                                                                                  color: (choosenTransportType == 2)
                                                                                                      ...
                                                                                                      : page,
                                                                                                  borderRadius: BorderRadius.circular(media.width * 0.02),
                                                                                                  border: Border.all(color: (choosenTransportType == 2) ? buttonColor : Colors.transparent, width: 2),
                                                                                                  // color: ,
                                                                                                ),
                                                                                                child: Column(
                                                                                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              ...
                              child: AnimatedContainer(
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      MyText(
                                        text: 'Choose Your Transport Type Here',
                                        size: media.width * sixteen,
                                        fontweight: FontWeight.w600,
                                        color: textColor,
                                      ),
